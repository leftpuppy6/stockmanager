...
export const itemRouter = createTRPCRouter({
  ...
  create: publicProcedure
    ...
    .mutation(({ ctx, input }) => {
      return ItemService(ctx.db).createItem(
        input.name,
        input.categoryId,
        input.threshold,
        input.locationId
  ...
  updateLocation: publicProcedure
    ...
    .mutation(({ ctx, input }) => {
      return ItemService(ctx.db).updateLocation(
        input.stockId,
        input.locationId
      );
  ...
  updateThreshold: publicProcedure
    ...
    .mutation(({ ctx, input }) => {
      return ItemService(ctx.db).updateThreshold(
        input.stockId,
        input.threshold
      );
    }),
  ...
  updatePurchaseFlag: publicProcedure
    ...
    .mutation(({ ctx, input }) => {
      return ItemService(ctx.db).updatePurchaseFlag(
        input.itemId,
        input.purchaseFlag
      );
    }),
